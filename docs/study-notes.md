# Study Notes
Ripped straight from my notebooks, so excuse the shorthands, incompleteness, and mistakes.
...
- [tmux - terminal multiplexer](/pages/tmux)
- [Tools I Use Daily](/pages/tools)
